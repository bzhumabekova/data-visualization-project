...
function scatterPlot(){
  ...
  const yAcc = d => d.y;
   ...
   // add lines
   xScale = d3.scaleLinear().domain(d3.extent(point, xAcc)).range([dimensions.margin.left+5, dimensions.boundedWidth-5]);
   yScale = d3.scaleLinear().domain(d3.extent(point, yAcc)).range([ dimensions.boundedHeight-5,dimensions.margin.top+5]);
 ...
 function clearButton(){
   ...
   // add lines
   xScale = d3.scaleLinear().domain([0, 10]).range([dimensions.margin.left+5, dimensions.boundedWidth-5]);
   yScale = d3.scaleLinear().domain([0, 10]).range([dimensions.boundedHeight-5, dimensions.margin.top+5 ]);
